...
int sumevennumbersfrom1ton_usindogwhile(int n)
{
	int counter = 0;
	int sum = 0;
...
int sumevennumbersfrom1ton_forstatement(int n)
{
	int sum = 0;
...
int main()
{
	...
	cout << sumevennumbersfrom1ton_usindogwhile(n) << endl;
	cout << sumevennumbersfrom1ton_forstatement(n) << endl;
	return 0;
